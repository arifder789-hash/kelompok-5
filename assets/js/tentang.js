...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      ...
      const phone = '6281200000000'; // ← GANTI dengan nomor WA asli
  ...
  // rootMargin: top offset = sticky navbar (68px) + subnav (~56px) = -130px
  // Without this, the observer triggers on sections hidden under sticky headers,
  // causing the wrong link (e.g. "Keunggulan") to stay active when "Perjalanan Kami" is in view
