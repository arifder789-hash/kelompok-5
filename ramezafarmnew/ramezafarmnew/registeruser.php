...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $no_telp = trim(mysqli_real_escape_string($conn, $_POST['no_telp'])); // Disamakan dengan name="no_telp"
    ...
    if (mysqli_num_rows($cek_user) > 0) {
        ...
        $query = "INSERT INTO pelanggan (username, password_pelanggan, no_telp) VALUES ('$username', '$password_aman', '$no_telp')";
