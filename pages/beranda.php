...
<section class="hero" id="hero" aria-label="Hero tentang kami">
  ...
  <div class="hero-content">
    ...
    <p class="hero-desc">
      Rameza Egg Farm hadir sebagai peternakan ayam petelur modern yang berfokus pada kualitas produksi, kesehatan unggas, serta distribusi telur segar yang higienis dan terpercaya setiap hari.
    </p>
  ...
  <div class="hero-visual">
    <div class="hero-img-wrap">
      <img
        ...
        alt="Kandang ayam petelur Rameza Farm"
...
<section class="products-section" id="produk">
  <div class="section-container">
    <div class="products-header">
      ...
      <a href="detailproduk.php" class="about-cta reveal" style="margin:0;">Lihat Semua Produk <span class="arrow">→</span></a>
    </div>
    ...
    <div class="products-grid">
      <div class="product-card reveal">
        ...
        <div class="product-body">
          ...
          <p class="product-desc">Ayam petelur sehat siap produksi. Cocok untuk peternak pemula maupun skala usaha besar.</p>
          <a href="detailproduk.php" class="product-link">Lihat Detail <span>→</span></a>
        </div>
      </div>
      ...
      <div class="product-card reveal reveal-delay-1">
        ...
        <div class="product-body">
          ...
          <p class="product-desc">Telur segar dipanen setiap hari. Higienis, bergizi, dan tersedia dalam berbagai ukuran kemasan.</p>
          <a href="detailproduk.php" class="product-link">Lihat Detail <span>→</span></a>
        </div>
      </div>
      ...
      <div class="product-card reveal reveal-delay-2">
        ...
        <div class="product-body">
          ...
          <p class="product-desc">Pakan berkualitas tinggi diformulasikan khusus untuk mendukung produktivitas dan kesehatan unggas optimal.</p>
          <a href="detailproduk.php" class="product-link">Lihat Detail <span>→</span></a>
        </div>
      </div>
      ...
      <div class="product-card reveal reveal-delay-3">
        ...
        <div class="product-body">
          ...
          <p class="product-desc">Produk kesehatan ternak pilihan untuk menjaga imunitas dan vitalitas unggas Anda tetap prima.</p>
          <a href="detailproduk.php" class="product-link">Lihat Detail <span>→</span></a>
        </div>
      </div>
    </div>
...
<section class="testi-section" id="testimoni">
  <div class="section-container">
    <div class="testi-header reveal">
      ...
      <p class="section-desc">Lebih dari 200 pelanggan aktif mempercayakan kebutuhan telur and pakan unggas mereka kepada Rameza Farm.</p>
    </div>
    ...
    <div class="testi-grid">
      <div class="testi-card reveal">
        ...
        <p class="testi-quote">Sudah 5 tahun saya ambil telur dari Rameza Farm buat warung makan saya. Kualitasnya konsisten, harganya bersaing, dan orangnya jujur. Nggak perlu pikir panjang soal pemasok telur lagi.</p>
      ...
      <div class="testi-card reveal reveal-delay-1">
        ...
        <p class="testi-quote">Beli bibit ayam di sini dan hasilnya luar biasa — tingkat hidup tinggi, pertumbuhannya bagus. Mas-mas di sini juga sabar kalau saya tanya-tanya soal cara ternak.</p>
        <div class="testi-author">
          <div class="testi-avatar">👨‍🌾</div>
          <div>
      ...
      <div class="testi-card reveal reveal-delay-2">
        ...
        <p class="testi-quote">Kami ambil stok telur besar setiap minggu untuk produksi kue. Telur Rameza selalu fresh, ukuran seragam, dan pengirimannya tepat waktu. Sangat direkomendasikan!</p>
        <div class="testi-author">
          <div class="testi-avatar">🎂</div>
          <div>
